...
This package is for Zarr version 3. Support for Zarr version 2 may be added in a later release.
...
```
You can also write to a Zarr array directly, for instance to set smaller subsets of the Zarr array. The process is a bit more complicated, however (due to a quirk in R):
```{r write}
